...
def get_args():
    ...
    #domains
    parser.add_argument("--source", help="Source" ,default='.data/amazon_0-9_train_all.txt')
    parser.add_argument("--target", help="Target", default='.data/webcam_0-9_20-30_test.txt')
    ...
    parser.add_argument("--log_dir", default=".log/of31/", help="Path of the log folder")
